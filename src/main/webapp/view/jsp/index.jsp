...
<header class="hero-section">
    <div class="content">
        <img src="/view/img/light-logo.png" class="logo" alt="">
...
<section class="collection-container">
    <a href="#" class="collection">
        <img src="/view/img/women-collection.png" alt="">
        <p class="collection-title">women <br> apparels</p>
    </a>
    <a href="#" class="collection">
        <img src="/view/img/men-collection.png" alt="">
        <p class="collection-title">men <br> apparels</p>
    </a>
    <a href="#" class="collection">
        <img src="/view/img/accessories-collection.png" alt="">
