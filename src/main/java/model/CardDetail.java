...
public class CardDetail {
    ...
    public CardDetail(int id, int id_product, int id_bill, double quantity_product, double bill_product) {
        this.id = id;
    ...
    public CardDetail(int id_product, int id_bill, double quantity_product, double bill_product) {
        this.id_product = id_product;
        this.id_bill = id_bill;
        this.quantity_product = quantity_product;
        this.bill_product = bill_product;
